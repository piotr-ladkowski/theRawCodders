...
export function DataTable<TData, TValue>({
  ...
  const deleteDispatchMutation = useMutation(api.dispatches.deleteDispatch)
    ...
    return (
      <AlertDialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
        <DropdownMenu>
          ...
          <DropdownMenuContent>
            <DropdownMenuGroup>
              <DropdownMenuItem onClick={() => { setSelectedDispatch(obj); setEditDispatchModalState(true);}}>
                  Edit
              </DropdownMenuItem>
              <DropdownMenuItem
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This action cannot be undone. This will permanently delete this dispatch from our servers.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
