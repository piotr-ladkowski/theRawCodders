...
export function MaintenanceDashboard() {
  ...
  const maintenanceLogs = useQuery(api.maintenance_logs.listMaintenanceLogsWithDates)
  ...
  return (
    <Card className="@container/card">
      <CardHeader>
        <CardTitle>Maintenance Logs Over Time</CardTitle>
        <CardDescription>
          <span className="hidden @[540px]/card:block">
            Number of equipment maintenance logs by date
          </span>
