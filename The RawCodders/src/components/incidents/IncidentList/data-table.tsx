...
export function DataTable<TData, TValue>({
      ...
      <AlertDialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This action cannot be undone. This will permanently delete this incident from our servers.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
  ...
  function RenderCell(accessorKey: string, incident: TIncident) {
                  ...
                  {row.getVisibleCells().map((cell) => {
                    ...
                    return (
                      <TableCell key={cell.id}>
                        {accessorKey === "action" || accessorKey === "status"
                          ? RenderCell(accessorKey, row.original as TIncident)
